...
public class BasicBehavior_Maze {
	...
	public static void main(String[] args) {
		...
		BasicBehavior_Maze example = new BasicBehavior_Maze();
	...
	public BasicBehavior_Maze() {

		// create the domain
		gwdg = new MazeDomain(25, 25);
		gwdg.setMapToMaze();
		...
		GridWorldDomain.setLocation(initialState, 0, 24, 24);
	...
	public void QLearningExample(String outputPath) {
		...
		// uncomment the learning strategy you want to use (and comment-out the
		// rest)
