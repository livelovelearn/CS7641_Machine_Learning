 ...
 *
 */
public class MyEpsilonGreedyQLearning extends OOMDPPlanner implements QComputablePlanner, LearningAgent{
	 ...
	 */
	public MyEpsilonGreedyQLearning(Domain domain, RewardFunction rf, TerminalFunction tf, double gamma, StateHashFactory hashingFactory, 
			double qInit, double learningRate) {
		this.QLInit(domain, rf, tf, gamma, hashingFactory, new ValueFunctionInitialization.ConstantValueFunctionInitialization(qInit), learningRate, new EpsilonGreedy(this, 0.5), Integer.MAX_VALUE);
	}
