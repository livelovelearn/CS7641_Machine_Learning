 ...
 *
 */
public class MyBoltzmannQLearning extends OOMDPPlanner implements
	 ...
	 *            the learning rate
	 */
	public MyBoltzmannQLearning(Domain domain, RewardFunction rf,
		...
		this.QLInit(
				...
				new ValueFunctionInitialization.ConstantValueFunctionInitialization(
						qInit), learningRate, new BoltzmannQPolicy(this, 100), // change temperature 100 , 25
				Integer.MAX_VALUE);
	}  
