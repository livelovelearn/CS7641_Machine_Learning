 ...
 *
 */
public class MyGreedyQLearning extends OOMDPPlanner implements QComputablePlanner, LearningAgent{
	 ...
	 */
	public MyGreedyQLearning(Domain domain, RewardFunction rf, TerminalFunction tf, double gamma, StateHashFactory hashingFactory, 
			double qInit, double learningRate) {
		this.QLInit(domain, rf, tf, gamma, hashingFactory, new ValueFunctionInitialization.ConstantValueFunctionInitialization(qInit), learningRate, new GreedyQPolicy(this), Integer.MAX_VALUE);
	}
